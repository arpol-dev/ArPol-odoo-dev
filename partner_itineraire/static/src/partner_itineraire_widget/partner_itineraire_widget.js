...
export class PartnerItineraireMap extends Component {
    ...
    _renderRoute() {
        ...
        const geometry = this._parseJson(this.props.value);
...
PartnerItineraireMap.extractProps = ({ attrs }) => {
    const opts = (attrs && attrs.options) || {};
    return {
        bboxField: opts.bbox_field || "itineraire_bbox",
        startLatField: opts.start_lat_field || "itineraire_start_lat",
        startLonField: opts.start_lon_field || "itineraire_start_lon",
        endLatField: opts.end_lat_field || "partner_latitude",
        endLonField: opts.end_lon_field || "partner_longitude",
        stateField: opts.state_field || "itineraire_state",
    };
};
PartnerItineraireMap.supportedTypes = ["text"];

registry.category("fields").add("partner_itineraire_map", PartnerItineraireMap);
